...
class PAA_LAD_Head(PAAHead):
    ...
    def _get_loss_la(self,
        ...
        #     label_channels=label_channels)#modified by jojo 20250415
        ...
        if gt_bboxes_ignore is not None:
            ...
            for bboxes in gt_bboxes_ignore:
                instance_ignore = InstanceData()
                instance_ignore.bboxes = bboxes
                batch_gt_instances_ignore.append(instance_ignore)
        else:
