...
#ADD BY SJJ 20250414 DUE TO COLAD
from .focal_kl_loss import FocalKLLoss
from .prob_focal_loss import ProbFocalLoss
from .dist_kd import  DIST
#constructed by jojo
from .hybrid_iou  import GIoUSmoothL1Loss
from .attention_distill import AttentionDistillLoss #add by jojo 20250515
from .non_local_distill import NonLocalDistillLoss #add by jojo 20250515
...
__all__ = [
    ...
    'FocalKLLoss','ProbFocalLoss','DIST',#Inter-intra class
    'GIoUSmoothL1Loss','AttentionDistillLoss',
    #ADD BY JOJO 20250414
]
