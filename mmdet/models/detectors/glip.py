...
class GLIP(SingleStageDetector):
    ...
    def __init__(self,
                 backbone: ConfigType,
                 neck: ConfigType,  #modified by jojo 20250416
        ...
        super().__init__(
            backbone=backbone,
            neck=neck,#modified by jojo 20250416
            bbox_head=bbox_head,
            train_cfg=train_cfg,
            test_cfg=test_cfg,
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        ]#modified by jojo 20250417
        text_prompts = ['crazing. inclusion. patches. pitted surface. rolled-in scale. scratches']
        # text_prompts = ['1_chongkong. 2_hanfeng. 3_yueyawan. 4_shuiban. 5_youban. 6_siban, 7_yiwu, 8_yahen, 9_zhehen, 10_yaozhe']
        ...
        # print("language_dict_features",language_dict_features["embedded"].shape)#[2,256,768]
        # print(language_dict_features["masks"].shape)#[2,256]
        # print(language_dict_features["hidden"].shape)#[2,256,768]
